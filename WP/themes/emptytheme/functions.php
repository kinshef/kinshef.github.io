...
if ( ! function_exists( 'emptytheme_setup' ) ) :
	...
	function emptytheme_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'emptytheme_custom_background_args', array(
...
function emptytheme_scripts() {
	wp_enqueue_style( 'emptytheme-style', get_stylesheet_uri() );

	wp_enqueue_script( 'emptytheme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
	
	wp_enqueue_script( 'emptytheme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
function bootstrap_styles_enqueue() {
	    // all styles
	wp_enqueue_style('bootstrap4-css',get_template_directory_uri().'/libs/bootstrap.min.css');
}
add_action( 'wp_enqueue_scripts', 'bootstrap_styles_enqueue',80 );
